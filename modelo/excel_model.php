 ...
 function exportarChecklist($data)
 {
  ...
  function exportarEjeChecklist($data)
  {
    ...
    // Check connection
        ...
        upper(ch.ruta_ife) as 'Ruta de IFE/INE',
        upper(ch.ife) as 'IFE / INE',
        upper(ch.ruta_curp) as 'Ruta de la CURP',
        upper(ch.curp) as 'CURP',
        upper(ch.ruta_comprobante) as 'Ruta de comprobante de domicilio',
        upper(ch.comprobante_domicilio) as 'Comprobante de domicilio',
        upper(ch.ruta_posesion) as 'Ruta de comprobante de posesion de terreno',
        upper(ch.posesion_terreno) as 'Comprobante de posesion de terreno',
        upper(ch.ruta_nacimiento) as 'Ruta de Acta de nacimiento',
        upper(ch.acta_nacimiento) as 'Acta de nacimiento',
        upper(l.nombre_completo) as 'Beneficiario'
        FROM ejecucion_checklist c INNER JOIN layout l on l.id_layout = c.id_layout INNER JOIN checklist ch on ch.id_layout = l.id_layout WHERE c.id_layout = $id;";
        $result = $conn->query($sql);
